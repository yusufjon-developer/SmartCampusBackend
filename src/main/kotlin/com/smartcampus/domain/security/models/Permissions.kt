...
object Permissions {
    ...
    const val TEACHERS_READ_INFO = "teachers:read_info"
    ...
    const val STUDENTS_READ_INFO = "students:read_info"
    ...
    fun getAllPermissionNames(): List<String> {
        return listOf(
            ...
            TEACHERS_CREATE, TEACHERS_READ_ALL, TEACHERS_READ_OWN, TEACHERS_UPDATE_ALL, TEACHERS_UPDATE_OWN, TEACHERS_DELETE, TEACHERS_READ_INFO, TEACHERS_INFO_UPDATE_ALL, TEACHERS_INFO_UPDATE_OWN,
            STUDENTS_CREATE, STUDENTS_READ_ALL, STUDENTS_READ_OWN, STUDENTS_UPDATE_ALL, STUDENTS_UPDATE_OWN, STUDENTS_DELETE, STUDENTS_READ_INFO, STUDENTS_INFO_UPDATE_ALL, STUDENTS_INFO_UPDATE_OWN,
