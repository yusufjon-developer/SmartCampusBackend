...
class StudentsRepositoryImpl(private val dao: StudentsDao) : StudentsRepository {
    ...
    override suspend fun getStudents(params: PageRequestParams): PaginatedResult<StudentListItemDto> = dao.getStudents(params)

    override suspend fun getStudentById(id: Int, includeSensitive: Boolean): StudentDetailsDto? = dao.getStudentById(id, includeSensitive)

    override suspend fun updateStudent(id: Int, request: StudentUpdateRequest, performingUserId: Int): StudentDetailsDto? =
